    ...
    <nav id="sidebar">
        ...
        <ul class="navbar-nav theme-brand flex-row  text-center">
            <li class="nav-item theme-text">
                <a href="{{route('home')}}" class="nav-link"> YOR System </a>
            </li>
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            @can('Reportes_index')
            <li class="menu">
                <a href="{{route('reports')}}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            @can('Arqueos_index')
            <li class="menu">
                <a href="{{route('cashouts')}}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu">
                <a href="{{route('products')}}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu">
                <a href="{{route('permisos')}}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            @can('Asignar_index')
            <li class="menu">
                <a href="{{route('asignar')}}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="users" data-parent="#accordionExample">
                    <li class="menu">
                        <a href="" onclick="event.preventDefault(); document.getElementById('logout-form1').submit()" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
