        ...
        <div class="widget-content">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-3 align-self-center d-flex justify-content-around">
                    ...
                    <button wire:click.prevent='Consultar()' class="btn btn-dark">
                        Consultar
                    </button>
                    @endif

                    @if ($total >0)
                        <button wire:click.prevent='Print()' class="btn btn-dark">
                            Imprimir
                        </button>
                    @endif
                </div>
        ...
        <div class="row mt-5">
            <div class="col-sm-12 col-md-4 mbmobile">
                <div class="connect-sorting bg-dark">
                    <h5 class="text-white">Ventas Totales: S/. {{number_format($total)}}</h5>
                        ...
                        <tbody>
                            ...
                            @foreach ($sales as $row)
                                <tr>
                                    ...
                                    <td class="text-center"><h6>S/. {{number_format($row->total,2)}}</h6></td>
