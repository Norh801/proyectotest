                    ...
                    <div id="style-3_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                        ...
                        <div class="table-responsive">
                            <table id="style-3" class="table style-3  table-hover">
                                <thead>
                                    <tr>
                                        <th class="table-th text-while text-center"> Usuario </th>
                                        ...
                                        <th class="text-center dt-no-sorting text-center">Acción</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if ($r->image != null)
                                                <img src="{{asset('storage/users/'.  $r->image)}}" alt="imagen de ejemplo" height="70" width="80" class="card-img-top img-fluid rounded">
                                            @endif
                                        </td>
                                        <td class="text-center">
