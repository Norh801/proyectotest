    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content ">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="input-group">
                        ...
                        <input type="text" wire:model.lazy="roleName" class="form-control" placeholder="ej: Admin" pattern="[a-zA-Z]+">
                        @error('roleName')
        ...
        <div class="modal-footer">
            ...
            @if ($selected_id < 1)
              <button type="button" wire:click.prevent="CreateRole()" class="btn close-modal"  style="background-color:#009688; color: white;">
                  Guardar
              </button>
            @else
              <button type="button" wire:click.prevent="UpdateRole()" class="btn close-modal" style="background-color:#fc9842; color: white;">
                  Actualizar
              </button>
            @endif
        </div>
